...
SetModel _setModelDeserialize(
  ...
  final object = SetModel(
    ...
    weight: reader.readLongOrNull(offsets[2]),
  );
  return object;
}
...
extension SetModelQueryFilter
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameIsNull() {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameEqualTo(
    String? value, {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameBetween(
    String? lower,
    String? upper, {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> exerciseNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'reps',
      ));
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'reps',
      ));
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'reps',
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SetModel, SetModel, QAfterFilterCondition> repsBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
